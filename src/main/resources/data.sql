...
INSERT INTO poemas(titulo, texto)
VALUES ('Besos olvidados',
'Besos antiguos queridos
...
INSERT INTO poemas(titulo, texto)
VALUES ('A la luna', 'Me he escondido algunas noches
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('Campanas', 'Campanas, son las campanas
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('Canto a la libertad','A un pájaro malherido                                                                      
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('Celos','Tengo celos de tus ojos
Pues a otro mirarán
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('El cantor','Todo ocurrió en una tarde
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('El delantal','Has sacado la colada
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('El herrero','Hay en el pueblo un herrero    
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('El jardín','Pasa cerca de mi casa
Un arroyo cantarín
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('Estrellas fugaces','Hoy es la noche de estrellas
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('La búsqueda','Hay en el puerto un barquito
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('La caída','Viniste del pueblo un día
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('La chopera','Las hojas en la chopera
Han empezado a caer
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('La lejanía','Estábamos muy callados
...
INSERT INTO poemas(titulo, texto)
VALUES ('La muñeca','En un oscuro desván
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('La noria','Infernal invento ese
...
');
INSERT INTO poemas(titulo, texto)
VALUES ('Las cuatro estaciones','PRIMAVERA
...
INSERT INTO poemas(titulo, texto)
VALUES('La gata','Apareciendo en el cielo
...
INSERT INTO relatos(titulo, texto)
VALUES ('El ladrón', '
...
');
INSERT INTO relatos(titulo, texto)
VALUES ('Rene', 'Caía ya la noche, cuando Rene tomó el coche cama que le dejaría a la mañana siguiente en la  madrileña  estación  de Chamartín.	Era un hombre de mediana estatura con  una  abundante cabellera blanca la cual le  proporcionaba un aspecto muy honorable.
...
Era bien entrada la tarde cuando se  dirigió a la calle de Calatrava, que por aquel entonces era una calle llena de pequeños comercios, en busca de su añorado café, que estaba situado  haciendo esquina con la de Toledo.
...
Subiendo por Cuchilleros se detuvo en un bar para refrescarse con una espumosa cerveza (por cierto, que en la citada calle se encuentra el restaurante más antiguo del mundo, "Sobrinos de Botín", que fue inaugurado en el año 1725).
...
Sin embargo, en quien centraría su atención era en una mujer que estaba sentada frente a un velador tratando de mantener su espalda bien erguida.
...
No pudiendo soportar más aquella situación, un buen día se decidió a jugarse el todo por el todo y cuando le vio acercarse, le detuvo y le dijo: “Renato, he estado pensando que ya que tú al salir de la academia recorres prácticamente el mismo camino que yo, podías acompañarme para ir a casa, pues me da mucho miedo bajar la cuesta sola y de noche”. 
...
“Me he escondido algunas noches 
huyendo de tu mirada
me parece despiadada
siempre llena de reproches
...
INSERT INTO relatos(titulo, texto)
VALUES ('Aventuras y desventuras de un niño en la Guerra Civil Española','Todas las citas literarias, quizá excesivas, han sido incluidas tratando de suavizar en lo posible unos hechos que deben ser desterrados para siempre. Las fechas y los datos de los diferentes personajes han sido tomados de varios historiadores. 
...
Recuerdo mi casa de la Ronda de Segovia, el sol entraba a raudales por la ventana que tenía el cuarto donde estaba situado el taller, con las mujeres cosiendo, mi padre inclinado sobre la mesa de cortar y yo sentado jugando con la caja de los hilos dando a la estancia una atmósfera especial propia de un cuadro como las Hilanderas de Velázquez.
	...
	Todo transcurría tranquilamente hasta aquel funesto día en el cual se precipitaron rápidamente los acontecimientos. 
...
La luz que iluminaba nuestra vivienda penetraba a través de una ventana situada al nivel de la calle y por la puerta acristalada de la parte superior, que daba al portal. Yo dormía en una habitación debajo del portal que recibía la luz a través de un grueso cristal translúcido. La ventana que daba a la calle, mi padre la cubrió totalmente con un colchón de lana, afianzándole con maderas clavadas en la pared.
	...
	Mi padre y mi hermana encontraron trabajo de su profesión: de sastrería en la calle de Fuencarral y de farmacia en el centro de Madrid.
